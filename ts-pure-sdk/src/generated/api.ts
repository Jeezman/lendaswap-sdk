...
export interface components {
  schemas: {
    ...
    CollabRefundEvmRequest: {
      ...
      /**
       * @description Refund mode: "direct" (WBTC back to depositor) or "swap" (DEX swap-back to original token)
       * @default direct
       */
      mode: string;
      ...
      /** @description Optional DEX calldata for swap-back mode. */
      dex_calldata?: components["schemas"]["DexCalldata"] | null;
    };
    ...
    CollabRefundEvmParams: {
       ...
       */
      chain_id: number;
      /** @description Settlement mode: direct or swap-back */
      mode: string;
